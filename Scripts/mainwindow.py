...
badd = Button(f, image=ph_add,
              command=(lambda t=w.add_info, f=w.fields, n=w.add, q=ph_quit, s=ph_sumbit: wt.create_win(t, f, n, q, s)))
badd.pack(fill=X)

bchange = Button(f, image=ph_ch,
                 command=(
                     lambda t=w.change_info, f=w.fields2, n=w.change, q=ph_quit, s=ph_sumbit: wt.create_win(t, f, n, q,
                                                                                                            s)))
bchange.pack(fill=X)
